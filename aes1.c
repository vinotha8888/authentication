...
#include<string.h>
#define Nb 4
PROCESS(function_call, "Hello world process");
AUTOSTART_PROCESSES(&function_call);
...
//void main()
//PROCESS_THREAD(function_call, ev, data)
char *aes(char temp2[16],char temp[16])
{
	static int i;
...
PROCESS_THREAD(function_call, ev, data)
{
 static char ran[16]="",c,ch;
 static int i,k=0,id=20,l=0,d,m;
static int a[16];
static char ri[]="abcdefghijklmnop";
static char ci[]="qrstuvwxyzabcdef";
//static char n1[]="abcdef";
//static char id[]='1';
